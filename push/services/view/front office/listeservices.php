...
if (isset($_GET['categorie']) && $_GET['categorie'] !== "") {
    $listServices = $serviceC->getServicesByCategorie($_GET['categorie']);
} else {
    $listServices = $serviceC->getServicesWithCategorie();
}
?>
									...
									<ul>
										...
										<li class="notifications-not-read">
											<a href="dashboard-messages.html">
												<span class="notification-avatar status-online"><img src="images/user-avatar-small-03.png" alt=""></span>
										...
										<li class="notifications-not-read">
											<a href="dashboard-messages.html">
												<span class="notification-avatar status-offline"><img src="images/user-avatar-small-02.png" alt=""></span>
												<div class="notification-text">
						...
						<div class="header-notifications-dropdown">
							...
							<div class="user-status">
								...
								<div class="user-details">
									<div class="user-avatar status-online"><img src="images/user-avatar-small-01.png" alt=""></div>
									<div class="user-name">
...
<div class="services-container list-layout margin-top-35">
    ...
    <div class="service-card">
        <a href="single-service-page.php?id=<?php echo $serviceData['id_service']; ?>" class="service-link">
            <div class="service-content">
                <!-- Service Image (vous pouvez ajouter une image si disponible) -->

                
                <!-- Service Details -->
                <div class="service-details">
                    <h3 class="service-title"><?php echo htmlspecialchars($serviceData['service_name']); ?></h3>
                    ...
                    <div class="service-meta">
                        ...
                        <span class="service-eco <?php echo $serviceData['eco_friendly'] ? 'eco' : 'non-eco'; ?>">
                ...
                <div class="service-action">
                    <div class="service-price">
                        <span class="price"><?php echo htmlspecialchars($serviceData['price']); ?> €</span>
