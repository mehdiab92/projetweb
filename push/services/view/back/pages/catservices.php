...
include_once '../../../Controller/serviceC.php';  // Inclure le contrôleur des services
$serviceC = new ServiceC();
$listeService = $serviceC->afficherServices(); 
...
<body class="g-sidenav-show  bg-gray-100">
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-dark shadow-dark border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">table Services </h6>
              </div>
            </div>
  ...
  <thead>
    <tr>
      ...
      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Nom du Service</th>
  ...
  <tbody>
    ...
    if (!empty($listeService)) {
      foreach ($listeService as $index => $service) {
        echo "<tr>
          <td>
            <div class='d-flex flex-column justify-content-center'>
          ...
          <td>
            <p class='text-xs font-weight-bold mb-0'>" . htmlspecialchars($service['service_description']) . "</p>
          </td>
          ...
          <td class='align-middle text-center'>
            ...
            <a href='supprimerservice.php?id=" . $service['id_service'] . "' onclick='return confirm(\"Êtes-vous sûr de vouloir supprimer ce service ?\")' class='btn btn-danger btn-sm'>Supprimer</a>
          </td>
      ...
      echo "<tr><td colspan='8' class='text-center'>Aucun service trouvé.</td></tr>";
    }
    ?>
  </tbody>
</table>
